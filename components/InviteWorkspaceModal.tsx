...
type Props = {
  show: boolean;
  onCloseModal: () => void;
  setIsShowInviteWorkspaceModal: (isShow: boolean) => void;
};

const InviteWorkspaceModal: FC<Props> = ({
  show,
  onCloseModal,
  setIsShowInviteWorkspaceModal: setIsShowCreateChannelModal,
}) => {
  ...
  return (
    <Modal show={show} onCloseModal={onCloseModal}>
      ...
      <form onSubmit={onInviteWorkspace} className="flex flex-col">
